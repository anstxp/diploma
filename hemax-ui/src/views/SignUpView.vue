...
import SignUpComponent from "@/components/auth-components/sign-up-component.vue";

export default {
  name: "SignUpView",
  components: { HeaderComponent, NavbarComponent, FooterComponent, BottomNavbarComponent, SignUpComponent },
};
</script>
