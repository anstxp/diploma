...
TASK_COLORS = {
    "told_htn":          "#3b82f6",
    "told_diabetes":     "#ef4444",
    "told_high_chol":    "#f59e0b",
    "told_chd":          "#8b5cf6",
    "told_chf":          "#ec4899",
    "told_stroke":       "#10b981",
}
...
TASK_NAMES_EN = {
    ...
    "told_diabetes":     "Type 2 Diabetes",
    "told_high_chol":    "Hypercholesterolemia",
    "told_chd":          "Coronary Heart Disease",
    "told_chf":          "Heart Failure",
    "told_stroke":       "Stroke",
}

CLINICAL_BASELINES = {
    "told_htn":       {"name": "Framingham HTN risk", "auc": 0.72, "ref": "Parikh 2008"},
    "told_diabetes":  {"name": "ADA risk score",      "auc": 0.78, "ref": "ADA 2003"},
    "told_high_chol": {"name": "ATP-III estimator",   "auc": 0.69, "ref": "NCEP 2002"},
    "told_chd":       {"name": "Framingham CHD",      "auc": 0.74, "ref": "D'Agostino 2008"},
    "told_chf":       {"name": "ARIC HF score",       "auc": 0.78, "ref": "Agarwal 2012"},
    "told_stroke":    {"name": "ASCVD-Pooled",        "auc": 0.74, "ref": "Goff 2013"},
}
