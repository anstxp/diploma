...
from risk_api.risk.model import HemaxRiskNet, ModelConfig, load_model  # noqa: E402
...
TARGETS = [
    ("told_htn", "Hypertension", "#1f77b4"),
    ("told_diabetes", "Type 2 Diabetes", "#d62728"),
    ("told_high_chol", "Hypercholesterolemia", "#ff7f0e"),
    ("told_chd", "Coronary Heart Disease", "#9467bd"),
    ("told_chf", "Heart Failure", "#e377c2"),
    ("told_stroke", "Stroke", "#2ca02c"),
]
...
def run_kfold_cv(K: int = 5, epochs: int = 6, seed: int = 42) -> Dict[str, list]:
    ...
    strat_y = pool["told_htn"].fillna(0).astype(int).to_numpy()
